            ...
            <div class="navbar-container ace-save-state" id="navbar-container">
                <div class="navbar-header pull-left">
                    ...
                    <button class="pull-right navbar-toggle navbar-toggle-img collapsed" type="button" data-toggle="collapse" data-target=".navbar-buttons,.navbar-menu">
                        ...
                        <img src="<?=$theme?>/assets/images/avatars/avatar2.png" alt="Jason's Photo" />
                    </button>
                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue dropdown-modal user-min">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="<?=$theme?>/assets/images/avatars/avatar2.png?>"/>
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        ...
                        <?php
                        $this->params['breadcrumbs'][] = ['label' => 'Logged in as '.Yii::$app->user->identity->access_role];
