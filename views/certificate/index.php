...
$list_cert_types = ArrayHelper::map(\app\models\CertificateType::find()->all(),'id','certificate_type_name');
?>
...
<div class="panel-body ">
    <div class="alert alert-info">
        Only accepted abstract will get certificate.
    </div>
    <p>
        <?= Html::a('Generate Certificate', ['generate'], ['class' => 'btn btn-success','data-method'=>'POST']) ?>
    </p>
    <?php
    $gridColumns = [
    [
