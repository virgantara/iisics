...
<div class="row">
    ...
    <?= Html::a('Update', ['update', 'id' => $model->abs_id], ['class' => 'btn btn-primary']) ?>
    <?= Html::a('Delete', ['delete', 'id' => $model->abs_id], [
    ...
    <?php 
        ...
        $disabled = ($model->abs_paid == 1 ? 'disabled' : '');
        echo Html::a('<i class="fa fa-money"></i> Upload Payment Proof', ['payment', 'id' => $model->abs_id], ['class' => 'btn btn-primary '.$disabled]);
            ...
            <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            'format' => 'raw',
                            'value' => function($data){
                                return ($data->abs_paid == 0 ? '<span class="label label-danger">UNPAID</span>' : '<span class="label label-success">PAID</span>');
                            }
                        ],
                        // 'examiner_by',
                        // [
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Abstract Review Results</h3>
            </div>
            <div class="panel-body ">
                <?php 
                if(Yii::$app->user->can('admin')){
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?=Html::dropDownList('abs_status','',$list_status_abstrak,['class'=>'form-control'])?>
                <?=Html::hiddenInput('abs_id',$model->abs_id,['id'=>'abs_id'])?>
            </div>
