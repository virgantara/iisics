...
/**
 * HomecontentSearch represents the model behind the search form of `app\models\Homecontent`.
 */
class HomecontentSearch extends Homecontent
{
    ...
    {
        return [
            [['page_id', 'page_view', 'sequence'], 'integer'],
            [['page_title', 'page_slug', 'page_description', 'page_content'], 'safe'],
        ];
    }
